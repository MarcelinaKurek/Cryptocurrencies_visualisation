...
public class Plots {
    ...
    public static void ExchangeRatePlot(String id, String currency, int days ){
        ...
        t.addColumns(x1, y);
        String title = id.toUpperCase() + " exchange rate growth";
        Plot.show(TimeSeriesPlot.create(title, t, "date", yaxis));

    }

    public static void ExchangeRateDiffPlot(String id, String currency, int days){
        Date[] dates = APIClient.getMarketChart(id, currency, days).keySet().toArray(new Date[0]);
        Double[] values = APIClient.getMarketChart(id, currency, days).values().toArray(new Double[0]);
        ...
        t3.addColumns(x1, y3);
        String title = id.toUpperCase() + " exchange rate growth";
        Plot.show(TimeSeriesPlot.create(title, t3, "date", "values"));
    }

    public static void CandleStickPlot(String id, String currency, int days){
    ...
    public static String formatNumber(long n){
        ...
        String number = numFormat.format(n).replace("E", " x 10^");
        return number;
    }
